    ...
    <>
      ...
      <div className="app">
        ...
        <section className="hero container">
          <div className="animate-in">
            ...
            <p className="hero-desc">
              ...
              <strong>Mechanical Engineering</strong>. I combine rigorous
              systems engineering with human-centered design to build scalable,
          ...
          <div className="grid-2">
            <div className="about-text">
              ...
              <p>
                ...
                <strong>Human-Computer Interaction</strong>. Whether I’m
                migrating a legacy codebase or designing an interface for
                Alzheimer’s patients, my goal is the same:
              </p>
        ...
        >
          ...
          <footer
            style={{marginTop: "5rem", fontSize: "0.85rem", opacity: 0.6}}
          >
